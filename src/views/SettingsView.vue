  ...
  <div class="settings-view">
    ...
    <div class="section-card">
      ...
      <div v-if="showForm" class="add-form">
        <div class="form-row">
          <div class="field">
            <label class="field-label" for="setting-category">카테고리 <span class="badge required">필수</span></label>
            <CategorySelect
              id="setting-category"
              class="form-select"
          ...
          <div class="field">
            <label class="field-label" for="setting-detail">세부 항목 <span class="badge optional">선택</span></label>
            <input
              id="setting-detail"
              class="form-input"
              type="text"
        ...
        <div class="form-row">
          <div class="field">
            <label class="field-label" for="setting-amount">금액 <span class="badge required">필수</span></label>
            <input
              id="setting-amount"
              class="form-input"
              type="text"
          ...
          <div class="field">
            <label class="field-label" for="setting-day">매월 결제일 <span class="badge required">필수</span></label>
            <input
              id="setting-day"
              class="form-input"
              type="number"
